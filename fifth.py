...
def is_gif(file_name):
    """
    Funkce zjistí, zda je soubor GIF (dvě možné hlavičky)
    """
...
def is_png(file_name):
    """
    Funkce zjistí, zda je soubor PNG
    """
...
if __name__ == '__main__':
    try:
        if len(sys.argv) < 2:
            raise Exception("Nebyl zadán vstupní soubor! Spusťte program takto: python fifth.py cesta/k/obrazku.png")
